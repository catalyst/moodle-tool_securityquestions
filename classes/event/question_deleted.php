...
/**
 * Event for logging deleted questions
 *
...
/**
 * Event for when questions are deleted
 *
...
class question_deleted extends \core\event\base {
     ...
     */
    public static function question_deleted_event($user, $content) {
    ...
    public function get_description() {
        return "The user with ID '{$this->other['userid']}' Deleted Security Question '{$this->other['content']}'.";
    }
    ...
    public static function get_name() {
        return get_string('questiondeletedeventname', 'tool_securityquestions');
    }
